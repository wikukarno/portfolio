...
export default function Index() {
    const { props } = usePage<
        PageProps & FlashProps & { tech: PaginatedCategory }
    >();
    ...
    const handleDelete = () => {
        if (confirmingId) {
            router.delete(route('admin.tech.stack.destroy', confirmingId), {
    ...
    return (
        <>
                    ...
                    <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                        <div className="overflow-hidden rounded-lg bg-white shadow-sm">
                            ...
                            <div className="flex items-center justify-between border-b p-6">
                                <TextHeaderCard
                                    title="Tech Stack"
                                    description="List of tech stack"
                                />

                                <Link
                                    href={route('admin.tech.stack.create')}
            ...
            <ConfirmationModal
                ...
                message="Are you sure you want to delete this tech stack?"
            />
        </>
    );
}
